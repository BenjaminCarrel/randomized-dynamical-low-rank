...
def solve_matrix_ivp(matrix_ode: MatrixOde, 
                     ...
                     monitor: bool = False) -> MatrixOdeSolution | Matrix:
    """
    ...
    # Check if nb_substeps is given in solver_kwargs
    solver_kwargs = solver_kwargs.copy()
    if 'nb_substeps' in solver_kwargs:
        nb_substeps = solver_kwargs['nb_substeps']
        del solver_kwargs['nb_substeps']
